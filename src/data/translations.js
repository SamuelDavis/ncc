...
export default {
  en: {
    ...
    NAV_NEWSLETTERS: "Newsletters",
    NAV_ABOUT_US: "About Us",
    NAV_PROGRAMS: "Programs",
    NAV_CALENDAR: "Calendar",
    NAV_VOLUNTEER: "Volunteer",
    NAV_PHOTO_JOURNAL: "Care Center Photo Journal",
    NAV_VOLUNTEER_EXTERNAL: "Volunteer Opportunities",
    FOOTER_HEADING_CONTACT: "Contact",
    FOOTER_HEADING_MISSION: "Mission",
    FOOTER_MISSION:
    ...
    ABOUT_VERSES_CITATION: "Psalm 100:1-2",
    ABOUT_PROGRAMS_HEADING: "Our Programs",
    ABOUT_PROGRAMS:
    ...
    PROGRAMS_CALENDAR_NAV: "Click here to see all of this month's activities.",
    VOLUNTEER_VOLUNTEER_HEADING: "Volunteer",
    VOLUNTEER_VOLUNTEER:
    ...
    VOLUNTEER_INVOLVED_HEADING: "Get Involved",
    VOLUNTEER_INVOLVED:
    ...
    VOLUNTEER_CONTACT_HEADING: "Contact C.A.R.E. Team",
    VOLUNTEER_CONTACT:
    ...
    VOLUNTEER_FORM_HEADING: "Contact Form",
